import{ab as c,r as n,aG as b,u as m,j as L,dz as p,aO as d,aI as f}from"./index-n8ng0CiC.js";function v(l){const{formatLanguageName:a}=c();return n.useMemo(()=>(l??[]).map(e=>({code:e,label:a(e)})).sort((e,s)=>e.label.localeCompare(s.label)),[l,a])}const x=d(`
