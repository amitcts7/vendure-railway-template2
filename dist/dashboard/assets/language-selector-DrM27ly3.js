import{_ as c,r as n,at as b,u as m,j as L,di as p,aB as v,av as d}from"./index-BpQC7dM6.js";function f(l){const{formatLanguageName:a}=c();return n.useMemo(()=>(l??[]).map(e=>({code:e,label:a(e)})).sort((e,s)=>e.label.localeCompare(s.label)),[l,a])}const x=v(`
